...
namespace Datumski_podaci
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(d1.ToLongDateString()); //ispisuje riječ za mjesec
            Console.WriteLine(d1.ToShortDateString());//dd.mm.yyyy.
            ...
            DateTime dNG = new DateTime(2021, 1, 1);
            ...
            Console.Write("Ili {0} dana {1} sati {2} minuta {3} sekundi", 
